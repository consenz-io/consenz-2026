          ...
          <CardContent>
            <div className="space-y-4">
              {steps[activeStep].steps.map((stepText, index) => (
                <div key={index} className="flex items-start gap-3 flex-row-reverse" dir="rtl">
                  ...
                  <p className="text-slate-700 pt-1 flex-1 text-right">{stepText}</p>
                </div>
              ))}
            </div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-16" dir={isRTL ? 'rtl' : 'ltr'}>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-8">
          ...
          <Card className="bg-white/80 backdrop-blur-sm border-green-200">
            ...
            <CardContent className="p-6">
              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 bg-green-50 rounded-lg border border-green-200" dir="rtl">
                  <div className="text-right">
                    <p className="font-semibold text-slate-900">
