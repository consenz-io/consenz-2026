    ...
    <div className="flex items-center gap-2 w-full">
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="flex items-center gap-2">
            <h3 className={`font-semibold break-words text-3xl md:text-3xl ${isRTL ? 'text-right' : 'text-left'}`} style={{ fontFamily: "'Times New Roman', 'David Libre', 'Noto Serif', Georgia, serif" }}>
              {(() => {
