...
export default function HeroSection({ documentsCount, displayedUsers, publicProfilesLoading, averageConsensus, onContributorsClick, contributorsCount }) {
  ...
  const description = {
    he: 'פלטפורמה המאפשרת לקהילות וארגונים לשתף את חבריהם בקבלת ההחלטות. מערכת ניקוד מעודדת השתתפות והופכת את התהליך לחוויה משחקית ומתגמלת. שילוב מנגנון ההצבעות חכם עם רכיבי דיון ועריכה מאפשר תהליך פורה גם באלפי משתתפים ויותר',
  ...
  return (
    <section className="relative overflow-hidden" aria-labelledby="hero-heading">
      ...
      <div className="relative max-w-7xl mx-auto px-6 md:py-32 py-20">
