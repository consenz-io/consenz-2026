  ...
  return (
    <section className="relative overflow-hidden" aria-labelledby="hero-heading">
      ...
      <div className="absolute top-0 left-0 right-0 flex justify-center pt-6 md:pt-10 pointer-events-none select-none" aria-hidden="true">
        <img src="https://media.base44.com/images/public/69ef99e5583af6a64ca3772e/5569749ec_image.png" alt="" className="w-24 h-24 md:w-32 md:h-32 opacity-80 rounded-2xl" />
      </div>
