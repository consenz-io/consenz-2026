...
const translations = {
  en: {
    ...
    supportThresholdDescription: "Number of supporters needed to approve a suggestion",
  ...
  he: {
    ...
    supportThresholdDescription: "מספר התומכים הדרוש לאישור הצעה",
  ...
  ar: {
    ...
    supportThresholdDescription: "عدد المؤيدين المطلوب للموافقة على اقتراح",
