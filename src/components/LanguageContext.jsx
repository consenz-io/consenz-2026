...
const translations = {
  en: {
    ...
    currentThresholdExplain: "Current support threshold required to approve suggestions in",
    participants: "participants",
    howThresholdWorks: "How does the threshold work?",
    thresholdExplanation: "The support threshold is dynamically calculated based on the consensus level of previously accepted suggestions. The more agreement there was on past suggestions, the higher the bar for future ones. This ensures the document maintains quality and broad support.",
    calculationBreakdown: "How is the threshold calculated?",
    avgConsensusMeter: "Average Consensus",
    totalParticipants: "Total Participants",
    currentThreshold: "Current Threshold",
    acceptedSuggestionsHistory: "Accepted Suggestions History",
    eachSuggestionAffectsThreshold: "Each accepted suggestion affects the future threshold",
    noAcceptedSuggestionsYet: "No suggestions have been accepted yet",
    defaultThresholdUsed: "The default threshold is being used",
    votesDelta: "Delta",
    suggestionConsensusMeter: "Suggestion Consensus Meter",
    calculatedAs: "Calculated as",
    averageOfAllSuggestions: "Average of All Suggestions",
    avgConsensusCalculation: "Average of {count} suggestions = {avg}%",
    whatThisMeans: "What does this mean?",
    thresholdMeaning: "To approve a new suggestion in this document, it needs to receive at least {threshold} more 'pro' votes than 'con' votes. This threshold reflects the level of agreement the community has shown on previous decisions.",
    },
  he: {
    // ניווט
    home: "בית",
    ...
    currentThresholdExplain: "סף התמיכה הנוכחי הנדרש לאישור הצעות ב",
    participants: "משתתפים",
    howThresholdWorks: "איך עובד סף התמיכה?",
    thresholdExplanation: "סף התמיכה מחושב באופן דינמי על בסיס רמת ההסכמה של הצעות שאושרו בעבר. ככל שהייתה הסכמה רחבה יותר על הצעות קודמות, כך הרף להצעות עתידיות גבוה יותר. זה מבטיח שהמסמך ישמור על איכות ותמיכה רחבה.",
    calculationBreakdown: "איך מחושב הסף?",
    avgConsensusMeter: "קונצנזוס ממוצע",
    totalParticipants: "סה״כ משתתפים",
    currentThreshold: "סף התמיכה הנוכחי",
    acceptedSuggestionsHistory: "היסטוריית הצעות שאושרו",
    eachSuggestionAffectsThreshold: "כל הצעה שמאושרת משפיעה על הסף העתידי",
    noAcceptedSuggestionsYet: "עדיין לא אושרו הצעות",
    defaultThresholdUsed: "נעשה שימוש בסף ברירת המחדל",
    votesDelta: "הפרש",
    suggestionConsensusMeter: "מד קונצנזוס להצעה",
    calculatedAs: "מחושב כ",
    averageOfAllSuggestions: "ממוצע כל ההצעות",
    avgConsensusCalculation: "ממוצע של {count} הצעות = {avg}%",
    whatThisMeans: "מה זה אומר?",
    thresholdMeaning: "כדי שהצעה חדשה תאושר במסמך זה, היא צריכה לקבל לפחות {threshold} קולות ׳בעד׳ יותר מקולות ׳נגד׳. סף זה משקף את רמת ההסכמה שהקהילה הפגינה בהחלטות קודמות.",
    },
  ar: {
    // التنقل
    home: "الرئيسية",
    ...
    currentThresholdExplain: "عتبة الدعم الحالية المطلوبة للموافقة على الاقتراحات في",
    participants: "مشاركين",
    howThresholdWorks: "كيف تعمل العتبة؟",
    thresholdExplanation: "يتم حساب عتبة الدعم ديناميكيًا بناءً على مستوى الإجماع للاقتراحات المقبولة سابقًا. كلما زاد الاتفاق على الاقتراحات السابقة، ارتفع الحد للاقتراحات المستقبلية. هذا يضمن الحفاظ على جودة المستند والدعم الواسع.",
    calculationBreakdown: "كيف يتم حساب العتبة؟",
    avgConsensusMeter: "متوسط الإجماع",
    totalParticipants: "إجمالي المشاركين",
    currentThreshold: "العتبة الحالية",
    acceptedSuggestionsHistory: "سجل الاقتراحات المقبولة",
    eachSuggestionAffectsThreshold: "كل اقتراح مقبول يؤثر على العتبة المستقبلية",
    ...
    calculatedAs: "محسوب كـ",
    averageOfAllSuggestions: "متوسط جميع الاقتراحات",
    avgConsensusCalculation: "متوسط {count} اقتراحات = {avg}%",
    whatThisMeans: "ماذا يعني هذا؟",
    thresholdMeaning: "للموافقة على اقتراح جديد في هذا المستند، يجب أن يحصل على {threshold} أصوات 'مع' أكثر من أصوات 'ضد' على الأقل. تعكس هذه العتبة مستوى الاتفاق الذي أظهره المجتمع في القرارات السابقة.",
    }
};
