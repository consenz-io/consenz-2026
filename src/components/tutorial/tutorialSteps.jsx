...
export const tutorialStrings = {
  he: {
    ...
    'editclause.explain.body': 'המסמך מחולק לנושאים וסעיפים, כל אחד מהם תוכן שנוצר בשיתוף פעולה. לא מסכימים עם ניסוח קיים? אפשר להציע לנסח מחדש כל סעיף — או להציע למחוק אותו לגמרי. גם שינויים כאלה עוברים הצבעה, ואם הקהילה תסכים — הם ייכנסו למסמך.',
