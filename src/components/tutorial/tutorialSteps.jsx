...
export const tutorialStrings = {
  he: {
    ...
    'editclause.explain.heading': 'עריכת המסמך בצורה שיתופית',
    'editclause.explain.body': 'Consenz מאפשרת להפוך דיונים מורכבים להסכמות רחבות. מערכת הצעות העריכה נותנת לכם את הכוח לדייק את המסמך המשותף: דרכה תוכלו להציע שינויים לכל סעיף, לנמק את עמדתכם ולהעמיד כל הצעה להצבעה. הצעות שיזכו לתמיכת הקהילה ייכנסו למסמך והוא יתעדכן אוטומטית.',
    ...
    'vote.explain.body': 'מצאתם הצעה מוצלחת? הצביעו ׳בעד׳ ותשפרו את סיכוייה להיכנס למסמך. ראיתם סעיף שלא אהבתם? הצביעו ׳נגד׳ כדי לקדם את הסרתו מהגרסה הבאה. כל קול משפיע על הנוסח הסופי.',
    'support.threshold.explain.heading': 'רף התומכים הדרוש',
    'support.threshold.explain.body': 'הבר הזה מציג כמה הצבעות חסרות לאישור הצעה או לביטול סעיף קיים. ככל שהתמיכה שקיבלה הגרסה העדכנית של המסמך גבוהה יותר, כך מספר המצביעים הדרוש לאישור הצעה או לביטול סעיף יהיה גבוה יותר',
    'newclause.explain.heading': 'משהו חסר במסמך?',
    'newclause.explain.body': 'אפשר להוסיף הצעה לסעיף חדש. כדי לראות את הכפתור להוספת סעיף - במחשב: העמידו את סמן העכבר במרווח שבין שני סעיפים. בנייד: לחצו על הרווח שבין הסעיפים. כפתור \'הוספת סעיף\' יופיע מיד.',
    ...
    'versions.browse.explain.body': 'מגרסה לגרסה, התמיכה במסמך גדלה בזכות ההצעות וההצבעות. דרך כפתורי הדפדוף ניתן לעקוב אחר תהליך יצירת הגרסה הנוכחית.',
    ...
    'points.ranking.explain.body': 'הניקוד משמש שני תפקידים: ראשית, הוא מסנן רעש — פרסום הצעות עריכה עולה נקודות. מנגד, הוא משקף השפעה — הצעות שמתקבלות מזכות את יוצריהן בנקודות. ככל שהשפעתם יותר, כך תוכלו להתבטא יותר בחופשיות.',
    ...
    'welcome.overlay.heading': 'ברוכים הבאים ל-Consenz',
    'welcome.overlay.body': 'בסיור קצר זה תקבלו הסבר צעד אחר צעד על השימוש בפלטפורמה: כיצד לקרוא מסמכים, להציע שינויים, להצביע, ולעקוב אחר ההיסטוריה של המסמך.',
    ...
    'ui.finish': 'סיום',
    'ui.tour': 'סיור',
    'ui.guidedTour': 'סיור מודרך',
    'ui.skip': 'דלגו',
    'ui.exit': 'סיים',
    'ui.continue': 'המשך סיור',
    'ui.exitPrompt': 'לסיים את הסיור?',
    ...
    'decomposition.explain.body': 'כדי שאלפים רבים יוכלו לכתוב יחד מסמך המשקף הסכמה, Consenz מאפשרת דיון ממוקד באמצעות פירוק המסמך לנושאים וסעיפים. כל משתתף ומשתתפת יכולים להתמקד בחלק שרלוונטי להם: להגיב על סעיף ספציפי, להציע שינויים לנוסח ולהצביע על הצעות של אחרים. כך הדיון לא מתפזר, לכולם קל להתמצא ולהבין את העמדות השונות, וההסכמה נבנית מלמטה למעלה.',
  },
  ar: {
    ...
    'doc.title.heading': 'فهم السياق',
    'doc.title.body': 'هنا يظهر اسم الوثيقة وهدفها العام. قراءة الخلفية ستساعدكم على تكوين صورة كاملة قبل التعمق في البنود المحددة واقتراح التغييرات.',
    'doc.counters.heading': 'نبض الوثيقة',
    ...
    'editclause.explain.heading': 'اقتراحات تعديل لبنود الوثيقة',
    'editclause.explain.body': 'تتيح Consenz تحويل النقاشات المعقّدة إلى توافقات واسعة. يمنحكم نظام اقتراحات التعديل القوة لتدقيق الوثيقة المشتركة: من خلاله يمكنكم اقتراح تغييرات على كل بند، وتبرير موقفكم، وطرح كل اقتراح لتصويت المجتمع. الاقتراحات التي تحظى بتأييد المجتمع تدخل الوثيقة وتتحدّث تلقائياً.',
    ...
    'newclause.explain.heading': 'هل تفتقد الوثيقة لشيء ما؟',
    'newclause.explain.body': 'يمكنكم إضافة اقتراح لبند جديد. لرؤية زر إضافة بند — على الحاسوب: مرروا مؤشر الفأرة في الفراغ بين بندين. على الجوال: اضغطوا على الفراغ بين البنود. سيظهر زر \'إضافة بند\' على الفور.',
    ...
    'versions.counter.explain.heading': 'وثيقة حية: تاريخ الإصدارات',
    ...
    'versions.browse.explain.body': 'من إصدار لآخر، ازداد التأييد للوثيقة بفضل الاقتراحات والتصويتات. من خلال أزرار التنقل يمكنكم متابعة العملية التي أنشأت الإصدار الحالي.',
    'versions.change.explain.heading': 'ترون بالضبط ما الذي تغيّر',
    'versions.change.explain.body': 'تُعرض التغييرات بوضوح: خلفية خضراء تشير إلى كلمات أُضيفت، وخلفية حمراء تشير إلى كلمات حُذفت. هكذا تعرفون دائماً ما الذي تغيّر بالضبط في كل إصدار.',
    ...
    'points.ranking.explain.body': 'للنقاط وظيفتان: أولاً، تصفي الضوضاء — نشر اقتراحات التعديل يكلّف نقاطاً. في المقابل، تعكس التأثير — الاقتراحات التي تُقبل تمنح أصحابها نقاطاً. كلما زاد تأثيركم، زادت حرية تعبيركم.',
    'points.ranking.explain.learnMore': 'كيف تكسب النقاط؟',
    'tour.summary.heading': 'ممتاز! الآن تعرفون كيفية استخدام النظام!',
    'tour.summary.body': 'لقد استعرضتم جميع أدوات Consenz: قراءة البنود، المقارنة بين الاقتراحات المختلفة، التصويت المؤثر، ومتابعة تاريخ إصدارات المجتمع. الآن القوة لتشكيل الوثيقة بين أيديكم.',
    'welcome.overlay.heading': 'مرحباً بكم في Consenz',
    'welcome.overlay.body': 'في هذه الجولة القصيرة ستحصلون على شرح خطوة بخطوة حول استخدام المنصة: كيفية قراءة الوثائق، اقتراح التغييرات، التصويت، ومتابعة تاريخ الوثيقة.',
    ...
    'ui.finish': 'إنهاء',
    'ui.tour': 'جولة',
    'ui.guidedTour': 'جولة موجهة',
    'ui.skip': 'تخطي',
    'ui.exit': 'خروج',
    'ui.continue': 'متابعة',
    'ui.exitPrompt': 'إنهاء الجولة؟',
  ...
  en: {
    ...
    'editclause.explain.heading': 'Edit proposals for the document\'s sections',
    'editclause.explain.body': 'Consenz turns complex discussions into broad consensus. The edit-proposal system gives you the power to refine the shared document: through it you can propose changes to any section, explain your reasoning, and put every proposal to a community vote. Proposals that win the community\'s support enter the document, and it updates automatically.',
    ...
    'newclause.explain.body': 'You can add a proposal for a new section. To see the add-section button — on desktop: hover your mouse in the gap between two sections. On mobile: tap the gap between sections. An "Add section" button will appear right away.',
    ...
    'versions.browse.explain.body': 'From version to version, support for the document grew thanks to the proposals and votes. Through the browsing buttons you can follow the process that created the current version.',
    ...
    'welcome.overlay.heading': 'Welcome to Consenz',
    'welcome.overlay.body': "In this short tour you'll get a step-by-step explanation of how to use the platform: how to read documents, propose changes, vote, and track the document's history.",
    ...
    'ui.finish': 'Finish',
    'ui.tour': 'Tour',
    'ui.guidedTour': 'Guided Tour',
    'ui.skip': 'Skip',
    'ui.exit': 'Exit',
    'ui.continue': 'Continue',
    'ui.exitPrompt': 'Exit the tour?',
