...
export const tutorialStrings = {
  he: {
    ...
    'consensus.meter.explain.heading': 'לב המערכת: מד הקונסנזוס',
    'consensus.meter.explain.body': 'זהו המנגנון שמחליט מתי הצעה הופכת לחלק רשמי מהמסמך. המדד מראה כמה קולות חסרים להצעה כדי לעבור את רף ההסכמה הקהילתי. ככל שהקהילה מסכימה על סעיפים קודמים, המערכת דורשת הסכמה רחבה יותר כדי למנוע מחטפים.',
