...
export const tutorialStrings = {
  he: {
    ...
    'home.groups.body': 'בקבוצה כותבים מסמכים ביחד, מציעים שינויים, ומצביעים על כל הצעה. יש לבחור קבוצה להמשך ההדרכה',
    'group.explain.heading': 'נעים להגיע לקבוצה',
    ...
    'group.docs.body': 'אלה המסמכים המשותפים של הקבוצה. יש ללחוץ על אחד מהם להמשך ההדרכה.',
    'doc.title.heading': 'להבין את ההקשר',
    'doc.title.body': 'כאן מופיעים שם המסמך ומטרת העל שלו. קריאת הרקע תעזור לקבל תמונה מלאה לפני שצוללים לסעיפים הספציפיים ומציעים שינויים.',
    'doc.counters.heading': 'הדופק של המסמך',
    'doc.counters.body': 'המספרים האלו מראים כמה משתתפים בעריכת המסמך, כמה הצעות פתוחות להצבעה, מהי רמת ההסכמה הכללית וכמה גרסאות כבר אושרו. בלחיצה על הנתון אפשר לראות מידע נוסף.',
    'editclause.explain.heading': 'התוכן גמיש – ופתוח לשינוי',
    'editclause.explain.body': 'המסמך מחולק לנושאים וסעיפים. לא מסכימים עם נוסח קיים? כל סעיף פתוח להצעות עריכה או מחיקה. הקהילה תצביע על ההצעה, ואם תזכה לתמיכה – המסמך יתעדכן אוטומטית!',
    'editclause.buttons.heading': 'איך מציעים שינוי?',
    'editclause.buttons.body': 'במחשב: יש להעביר את העכבר מעל הסעיף. בנייד: יש ללחוץ לחיצה קלה על הסעיף. כפתור העריכה יופיע ויאפשר להציע שינויים להצבעה.',
    'browse.explain.heading': 'דפדוף בין הצעות עריכה',
    'browse.explain.body': 'אם פורסמו הצעות לשינוי הסעיף יופיעו כאן חצי דפדוף שיאפשרו להשוות בין הרעיונות שהוצעו.',
    'vote.explain.heading': 'כל קול קובע ומכריע',
    'vote.explain.body': 'יש הצעה מוצלחת? אפשר להצביע ׳בעד׳ ולשפר את סיכוייה להתקבל ולהיכנס למסמך. יש סעיף קיים שלא מסכימים איתו? אפשר להצביע ׳נגד׳ כדי לקדם את הסרתו מהגרסה הבאה. כל קול משפיע על הניסוח הסופי של המסמך.',
    ...
    'newclause.explain.body': 'אפשר להוסיף הצעה לסעיף חדש. כדי לראות את הכפתור להוספת סעיף - במחשב: יש להעמיד את סמן העכבר במרווח שבין שני סעיפים. בנייד: יש ללחוץ על הרווח שבין הסעיפים. כפתור \'הוספת סעיף\' יופיע מיד.',
    'consensus.meter.explain.heading': 'מד הקונסנזוס',
    'consensus.meter.explain.body': 'המד מציג את רמת ההסכמה במסמך. ככל שהיא גבוהה יותר — כך גבוה יותר הרף להצעה להתקבל. בלחיצה אפשר לראות מידע נוסף וללמוד איך מד הקונסנזוס מחושב.',
    'versions.counter.explain.heading': 'מסמך חי: היסטוריית הגרסאות',
    'versions.counter.explain.body': 'כל הצעה שהתקבלה יצרה גרסה חדשה למסמך. הספרה הזו מייצגת את מספר הגרסאות הקודמות של המסמך. בלחיצה עליה אפשר לראות את היסטוריית השינויים.',
    'versions.browse.explain.heading': 'לראות איך המסמך התפתח',
    'versions.browse.explain.body': 'כל גרסה מייצגת הסכמה שהקהילה הגיעה אליה בעבר. מגרסה לגרסה, התמיכה במסמך גדלה בזכות ההצעות וההצבעות. כאן קיים תיעוד מלא של איך המסמך התפתח.',
    'versions.change.explain.heading': 'רואים בדיוק מה השתנה',
    'versions.change.explain.body': 'שינויים מוצגים בצורה ברורה: רקע ירוק מסמן מילים שנוספו, ורקע אדום מסמן מילים שנמחקו. כך אפשר לדעת תמיד מה בדיוק השתנה בכל גרסה.',
    'sidebar.explain.heading': 'פרטי ההצעה שהובילה לשינוי',
    'sidebar.explain.body': 'כאן אפשר לראות את הדיון המלא — מה הציעו, כמה הצביעו, ומה הטיעונים שנאמרו. כל שינוי במסמך עבר תהליך כזה של דיון והצבעה קהילתית.',
    'points.ranking.explain.heading': 'מערכת הניקוד',
    'points.ranking.explain.body': 'הניקוד משמש שני תפקידים: ראשית, הוא מסנן רעש — כשמציעים רעיון, זה עולה נקודות. שנית, הוא משקף השפעה — כשהקהילה תומכת בהצעה, ההחזר גדול הרבה יותר. ככל שהתרומות משפיעות יותר, הניקוד גדל.',
    'points.ranking.explain.learnMore': 'איך צוברים נקודות?',
    'tour.summary.heading': 'מצוין! עכשיו ברור איך להשתמש במערכת!',
    'tour.summary.body': 'סיור זה עבר על כל הכלים של Consenz: קריאת סעיפים, השוואה בין הצעות שונות, הצבעה משפיעה, ומעקב אחר היסטוריית הגרסאות של הקהילה. עכשיו הכוח לעצב את המסמך בידי הקהילה.',
    'welcome.overlay.heading': 'שלום! זהו סיור בפלטפורמה',
    'welcome.overlay.body': 'בסיור קצר זה מוצע הסבר צעד אחר צעד על השימוש בפלטפורמה: כיצד לקרוא מסמכים, להציע שינויים, להצביע, ולעקוב אחר ההיסטוריה של המסמך. בואו נתחיל מעמוד הבית.',
    'welcome.overlay.cta': 'בואו נתחיל',
    'welcome.intro.prepare.heading': 'נעים להתחיל את הסיור',
    'welcome.intro.prepare.body': 'בקבוצה אפשר לדון, להשתתף בכתיבה משותפת, ולצפות כיצד הקהילה בונה מסמכים ביחד. בואו נתחיל בהבנת מה זו קבוצה.',
    'nav.restart': 'סיור בפלטפורמה',
    'signup.prompt.heading': 'כדי להמשיך צריך להירשם',
    'signup.prompt.body': 'ההרשמה חינמית ולוקחת שניות. אחרי ההרשמה חוזרים בדיוק לכאן.',
