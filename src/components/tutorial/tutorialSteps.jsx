...
export const tutorialStrings = {
  he: {
    ...
    'versions.explain.body': 'כל הצעה שהתקבלה יצרה גרסה חדשה. בואו לעמוד הגרסאות כדי לראות את ההיסטוריה המלאה — מה השתנה, מתי, ועל ידי מי.',
    'versions.list.heading': 'דפדפו בין גרסאות של המסמך',
    'versions.list.body': 'כל קו בתור זה גרסה אחת. הגרסה החדשה ביותר בחלק העליון. לחצו על גרסה כדי לראות בדיוק מה השתנה.',
    'versions.types.heading': 'סוגי השינויים',
    'versions.types.body': 'כל גרסה משקפת שינוי אחר — אם סעיף נוסף, אם סעיף נמחק, אם סעיף נערך, או אם מנהל/מנהלת שינו משהו ישירות. הצבעים מעזרים: ירוק = נוסף, אדום = הוסר.',
    'versions.discussion.heading': 'צלול לפרטים של כל גרסה',
    'versions.discussion.body': 'כשלוחצים על גרסה, סיידבר מימין מראה את כל הדיון — מי הציע את השינוי, למה, כמה הצביעו בעד — וכל ההערות של הקהילה.',
  ...
  ar: {
    ...
    'versions.explain.body': 'كل مقترح قُبل أنشأ نسخة جديدة. توجهوا إلى صفحة النسخ لرؤية التاريخ الكامل — ما الذي تغيّر، ومتى، ومن اقترحه.',
    'versions.list.heading': 'تصفحوا نسخ الوثيقة',
    'versions.list.body': 'كل صف في القائمة هو نسخة واحدة. أحدث نسخة في الأعلى. انقروا على نسخة لرؤية بالضبط ما تغيّر.',
    'versions.types.heading': 'أنواع التغييرات',
    'versions.types.body': 'كل نسخة تعكس نوعاً مختلفاً من التغيير — سواء أُضيف بند، أو حُذف، أو عُدِّل، أو قام إداري بتغيير مباشر. الألوان تساعد: أخضر = مُضاف، أحمر = محذوف.',
    'versions.discussion.heading': 'انغمروا في تفاصيل كل نسخة',
    'versions.discussion.body': 'عند النقر على نسخة، شريط جانبي على اليمين يعرض كل النقاش — من اقترح التغيير، لماذا، كم شخصاً صوت له — وكل التعليقات المجتمعية.',
  ...
  en: {
    ...
    'versions.explain.body': 'Every accepted proposal created a new version. Go to the versions page to see the full history — what changed, when, and by whom.',
    'versions.list.heading': 'Browse document versions',
    'versions.list.body': 'Each row in the list is one version. The newest version is at the top. Click on a version to see exactly what changed.',
    'versions.types.heading': 'Types of changes',
    'versions.types.body': 'Each version reflects a different kind of change — whether a clause was added, deleted, edited, or if an admin made a direct change. Colors help: green = added, red = removed.',
    'versions.discussion.heading': 'Dive into the details of each version',
    'versions.discussion.body': 'When you click on a version, a sidebar on the right shows all the discussion — who proposed the change, why, how many voted for it — and all community feedback.',
...
export const TUTORIAL_STEPS = [
  ...
  {
    id: 'versions-list-explain',
    type: 'explain',
    targetSelector: '.versions-list',
    tooltipPosition: 'right',
    heading: 'versions.list.heading',
    body: 'versions.list.body',
  },
  {
    id: 'versions-types-explain',
    type: 'explain',
    targetSelector: '.version-change-type-badge',
    tooltipPosition: 'right',
    heading: 'versions.types.heading',
    body: 'versions.types.body',
  },
  {
    id: 'versions-discussion-explain',
    type: 'explain',
    targetSelector: '.version-discussion-sidebar',
    tooltipPosition: 'left',
    heading: 'versions.discussion.heading',
    body: 'versions.discussion.body',
  },
  {
    id: 'points-explain',
    type: 'explain',
