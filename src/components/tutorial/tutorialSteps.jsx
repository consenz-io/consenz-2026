...
export const tutorialStrings = {
  he: {
    ...
    'newclause.practice.heading': 'העמידו את סמן העכבר או לחצו על מסך המגע מתחת הסעיף שאחריו תרצו להוסיף הצעה לסעיף חדש, ולחצו על הכפתור שיוצג',
  ...
  ar: {
    ...
    'newclause.practice.heading': 'مرروا المؤشر أو اضغطوا على الشاشة أسفل البند الذي بعده تريدون إضافة بند جديد، واضغطوا على الزر الذي سيظهر',
  ...
  en: {
    ...
    'newclause.practice.heading': 'Hover your mouse or tap on the screen below the section after which you want to add a new clause, and click the button that appears',
