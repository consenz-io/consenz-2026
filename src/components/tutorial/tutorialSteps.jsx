...
export const tutorialStrings = {
  he: {
    ...
    'welcome.overlay.heading': 'ברוכים הבאים לסיור',
    'welcome.overlay.body': 'בסיור קצר זה תקבלו הסבר צעד אחר צעד על השימוש ב-Consenz: כיצד לקרוא מסמכים, להציע שינויים, להצביע, ולעקוב אחר ההיסטוריה של המסמך.',
