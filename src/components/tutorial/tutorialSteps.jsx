...
export const tutorialStrings = {
  ...
  en: {
    ...
    'browse.encourage.body': 'To see what changes participants in the discussion proposed for editing this section. Click the browsing buttons between edit proposals to continue.',
