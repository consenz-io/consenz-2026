...
export const tutorialStrings = {
  he: {
    ...
    'newclause.practice.heading': 'מצאו את כפתור "הוסף סעיף" בין הסעיפים וההציעו תוכן חדש',
  ...
  ar: {
    ...
    'newclause.practice.heading': 'ابحثوا عن زر "إضافة بند" بين البنود واقترحوا محتوى جديداً',
  ...
  en: {
    ...
    'newclause.practice.heading': 'Find the "Add section" button between the sections and propose new content',
