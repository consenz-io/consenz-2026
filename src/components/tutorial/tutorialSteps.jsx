...
export const tutorialStrings = {
  he: {
    ...
    'decomposition.explain.body': 'כדי שאלפים רבים יוכלו לכתוב יחד מסמך המשקף הסכמה, consenz מאפשרת דיון ממוקד באמצעות פירוק המסמך לנושאים וסעיפים. כל משתתף ומשתתפת יכולים להתמקד בחלק שרלוונטי להם: להגיב על סעיף ספציפי, להציע שינויים לנוסח ולהצביע על הצעות של אחרים. כך הדיון לא מתפזר, קל להתמצא ולהבין את העמדות השונות, וההסכמה נבנית מלמטה למעלה.',
  },
  ar: {
