...
export const tutorialStrings = {
  he: {
    ...
    'editclause.explain.heading': 'הצעות עריכה לסעיפי המסמך',
    'editclause.explain.body': 'Consenz מאפשרת להפוך דיונים מורכבים להסכמות רחבות. מערכת הצעות העריכה נותנת לכם את הכוח לדייק את המסמך המשותף: דרכה תוכלו להציע שינויים לכל סעיף, לנמק את עמדתכם ולהעמיד כל הצעה להצבעת הקהילה. הצעות שיזכו לתמיכת הקהילה ייכנסו למסמך והוא יתעדכן אוטומטית.',
