...
export const tutorialStrings = {
  he: {
    ...
    'versions.browse.explain.body': 'מגרסה לגרסה, התמיכה במסמך גדלה בזכות ההצעות וההצבעות. דרך כפתורי הדפדוף ניתן לעקוב אחר תהליך יצירת הגרסה הנוכחית.',    'versions.change.explain.heading': 'רואים בדיוק מה השתנה',
