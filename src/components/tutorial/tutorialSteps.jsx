...
export const tutorialStrings = {
  he: {
    ...
    'editclause.explain.body': 'לא מסכימים עם תוכן המסמך? כל סעיף פתוח להצעות עריכה. הקהילה תצביע על ההצעה שלכם, ואם תזכו לתמיכה – המסמך יתעדכן אוטומטית!',
  ...
  ar: {
    ...
    'editclause.explain.body': 'لا توافقون على محتوى الوثيقة؟ كل بند مفتوح لاقتراحات التعديل. سيصوّت المجتمع على اقتراحكم، وإذا حظي بالتأييد — ستتحدّث الوثيقة تلقائياً!',
  ...
  en: {
    ...
    'editclause.explain.body': 'Don\'t agree with the document\'s content? Every section is open to edit proposals. The community will vote on your proposal, and if it gains support — the document updates automatically!',
