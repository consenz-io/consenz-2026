...
export const tutorialStrings = {
  he: {
    ...
    'cleanview.intro.heading': 'זוהי הגרסה העדכנית ביותר של המסמך',
    'cleanview.intro.body': 'הסעיפים שרואים כאן מייצגים את הסכמת המשתתפים בתהליך יצירת המסמך על בסיס הדיון וההצבעות. כל שינוי שאתם רואים כאן התקבל בהצבעה קהילתית.',
    ...
    'cleanview.previous.heading': 'הגעה לגרסה קודמת',
    'cleanview.previous.body': 'כל גרסה מאחסנת מצב קודם של המסמך. בגרסה הקודמת תוכלו לראות מה היה לפני השינוי האחרון.',
  ...
  ar: {
    ...
    'cleanview.intro.heading': 'هذا هو أحدث إصدار من الوثيقة',
    'cleanview.intro.body': 'البنود التي ترونها هنا تمثل توافق المشاركين في عملية إنشاء الوثيقة على أساس النقاش والتصويت. كل تغيير تشاهدونه هنا تمت الموافقة عليه من خلال تصويت المجتمع.',
    ...
    'cleanview.previous.heading': 'الوصول إلى الإصدار السابق',
    'cleanview.previous.body': 'كل إصدار يخزن حالة سابقة من الوثيقة. في الإصدار السابق يمكنكم رؤية ما كان قبل آخر تغيير.',
  ...
  en: {
    ...
    'cleanview.intro.heading': 'This is the latest version of the document',
    'cleanview.intro.body': 'The sections you see here represent the consensus reached by participants in the document creation process based on discussion and voting. Every change you see here was approved through community voting.',
    ...
    'cleanview.previous.heading': 'Accessing the previous version',
    'cleanview.previous.body': 'Each version stores a previous state of the document. In the previous version you can see what was there before the last change.',
...
export const TUTORIAL_STEPS = [
  ...
  },
  {
    ...
    targetSelector: '.document-title-area',
    tooltipPosition: 'bottom',
    heading: 'cleanview.intro.heading',
    body: 'cleanview.intro.body',
  },
  {
  ...
  {
    id: 'cleanview-previous-version',
    type: 'explain',
    targetSelector: '.version-metadata',
    tooltipPosition: 'bottom',
    heading: 'cleanview.previous.heading',
    body: 'cleanview.previous.body',
  },
  {
