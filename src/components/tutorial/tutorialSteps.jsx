...
export const tutorialStrings = {
  he: {
    ...
    'versions.browse.explain.body': 'כל גרסה מייצגת הסכמה שהקהילה הגיעה אליה בעבר. מגרסה לגרסה, התמיכה במסמך גדלה בזכות ההצעות וההצבעות. כאן קיים תיעוד מלא של איך המסמך התפתח.',    'versions.change.explain.heading': 'רואים בדיוק מה השתנה',
