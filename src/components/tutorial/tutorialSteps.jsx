...
export const tutorialStrings = {
  he: {
    ...
    'docData.heading': 'נתוני המסמך',
    'docData.body': 'בקטע הזה אפשר לעבור בין הצעות פתוחות להתאמת המסמך — לחצו על הקאונטר העליון כדי לדפדף בין ההצעות.',
    ...
    'newclause.practice.heading': 'הזינו את התוכן של הסעיף החדש שברצונכם להציע',
    'newclause.practice.body': 'כתבו את ההצעה שלכם כאן. תוכלו גם להוסיף הסבר למה דעתכם שזה חשוב.',
  ...
  ar: {
    ...
    'docData.heading': 'بيانات الوثيقة',
    'docData.body': 'في هذا القسم يمكنكم التنقل بين المقترحات المفتوحة لتحرير الوثيقة — اضغطوا على العداد العلوي للتصفح بين المقترحات.',
    ...
    'newclause.practice.heading': 'أدخلوا محتوى البند الجديد الذي تريدون اقتراحه',
    'newclause.practice.body': 'اكتبوا اقتراحكم هنا. يمكنكم أيضاً إضافة شرح لماذا تعتقدون أن هذا مهم.',
  ...
  en: {
    ...
    'docData.heading': 'Document data',
    'docData.body': 'In this section you can navigate between open proposals to edit the document — click on the counter above to browse through the proposals.',
    ...
    'newclause.practice.heading': 'Enter the content of the new section you want to propose',
    'newclause.practice.body': 'Write your proposal here. You can also add an explanation for why you think it\'s important.',
...
export const TUTORIAL_STEPS = [
  ...
  },
  {
    ...
    type: 'practice',
    requiresAuth: true,
    targetSelector: '.create-suggestion-modal input[placeholder*="תוכן"]',
    tooltipPosition: 'top',
    heading: 'newclause.practice.heading',
    body: 'newclause.practice.body',
