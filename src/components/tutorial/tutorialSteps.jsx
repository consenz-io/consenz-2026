...
export const tutorialStrings = {
  he: {
    ...
    'consensus.meter.explain.heading': 'רף הקונסנזוס — דינמי והוגן',
    'consensus.meter.explain.body': 'המד הזה מציג את אחוז הקונסנזוס של המסמך כרגע. רף התומכים הדרוש להצעה להתקבל מחושב בהתאם לאחוז זה — ככל שרמת הקונסנזוס גבוהה יותר, כך גבוה יותר הקול הדרוש מהתומכים. בצעו לחיצה על המד כדי ללמוד עוד על אופן החישוב שלו.',
