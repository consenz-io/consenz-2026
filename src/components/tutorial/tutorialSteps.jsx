...
export const tutorialStrings = {
  he: {
    ...
    'browse.encourage.body': 'השתמש בחצים כדי לראות הצעות שונות.',
  ...
  ar: {
    ...
    'browse.encourage.body': 'استخدموا الأسهم لرؤية مقترحات مختلفة.',
  ...
  en: {
    ...
    'browse.encourage.body': 'Use the arrows to see different proposals.',
