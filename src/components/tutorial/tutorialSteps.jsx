...
export const tutorialStrings = {
  he: {
    ...
    'editclause.explain.body': 'הפלטפורמה מאפשרת להפוך דיונים מורכבים להסכמות רחבות. מערכת הצעות העריכה מאפשרת לכם לדייק את המסמך המשותף: דרכה תוכלו להציע שינויים לכל סעיף, לנמק את עמדתכם ולהעמיד כל הצעה להצבעה. הצעות שיזכו לתמיכת הקהילה ייכנסו למסמך והוא יתעדכן אוטומטית.',
